...
A private income and expense tracker for a Malaysian sole proprietor to record business transactions, filter by year/category, and generate LHDN e-B ready annual and monthly summaries.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "69916634+bernchang95@users.noreply.github.com"
  git config user.name "bernchang95"
  ```
